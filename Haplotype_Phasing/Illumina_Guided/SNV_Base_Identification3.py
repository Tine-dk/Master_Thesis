...
snv_positions = set()
with open (path + "illumina_guided_hp/illumina_VCF_subset_filtered/"+sample+"_"+gene+"_Illumina_Dragen_Filtered_SNVs_window"+window+"_AF_0_"+AF_low+"_to_0_"+AF_high+"_DP"+DP+".vcf", "r") as f:
    for line in f:
...
read_names = list()
with open (path + "illumina_guided_hp/ONT_BAM_subset_readnames/"+sample+"_"+gene+"_Read_Name_window"+window+"_AF_0_"+AF_low+"_to_0_"+AF_high+"_DP"+DP+".txt", "r") as f:
    for line in f:
...
bamfile = pysam.AlignmentFile(path + "illumina_guided_hp/ONT_BAM_subset/"+sample+"_"+gene+"_window"+window+"_AF_0_"+AF_low+"_to_0_"+AF_high+"_DP"+DP+".bam", "rb")
...
snv_df.to_csv(path + "illumina_guided_hp/results_dataframes/"+sample+"_"+gene+"_bases_window"+window+"_AF_0_"+AF_low+"_to_0_"+AF_high+"_DP"+DP+".txt", sep=',', mode='w',na_rep='NA')
