...
snv_positions = set()
with open (path + "longshot_ny2/longshot_vcf_subset_filtered_hom/"+sample+"_"+gene+"_longshot_Filtered_hom_SNVs_window"+window+"_DP"+DP+".vcf", "r") as f:
    for line in f:
...
snv_df.to_csv(path + "longshot_ny2/results_dataframes/longshot_"+sample+"_"+gene+"_hom_bases_window"+window+"_DP"+DP+".txt", sep=',', mode='w',na_rep='NA')
